...
const candidates = [
  { name: 'Amit Kumar',       mobile: '9876543210', job_id: 'JOB-001', interviewer: 'Vikram Singh', hr_spoc: 'Priya Sharma', stage: 'Interview', email: 'amit.kumar@email.com',    current_company: 'TCS',          experience: '3 years', current_ctc: '8 LPA',  expected_ctc: '12 LPA', notice_period: '30 days' },
  ...
  { name: 'Kavitha Sundaram', mobile: '9876543215', job_id: 'JOB-003', interviewer: 'Lakshmi Rao',  hr_spoc: 'Anita Desai',  stage: 'Interview', email: 'kavitha.s@email.com',     current_company: 'Accenture',    experience: '4 years', current_ctc: '9 LPA',  expected_ctc: '14 LPA', notice_period: '60 days' },
  ...
  { name: 'Sanjay Mehta',     mobile: '9876543218', job_id: 'JOB-004', interviewer: 'Anil Kapoor',  hr_spoc: 'Anita Desai',  stage: 'Interview', email: 'sanjay.m@email.com',      current_company: 'Tech Mahindra',experience: '3 years', current_ctc: '7 LPA',  expected_ctc: '11 LPA', notice_period: '30 days' },
  ...
  { name: 'Karan Malhotra',   mobile: '9876543222', job_id: 'JOB-007', interviewer: 'Ravi Shankar', hr_spoc: 'Priya Sharma', stage: 'Interview', email: 'karan.m@email.com',       current_company: 'Mphasis',      experience: '3 years', current_ctc: '8 LPA',  expected_ctc: '13 LPA', notice_period: '30 days' },
  ...
  { name: 'Ananya Chatterjee',mobile: '9876543225', job_id: 'JOB-008', interviewer: 'Suresh Menon', hr_spoc: 'Rahul Verma',  stage: 'Interview', email: 'ananya.c@email.com',      current_company: 'IBM',          experience: '6 years', current_ctc: '16 LPA', expected_ctc: '22 LPA', notice_period: '30 days' },
